...
def matrixFunctionality():
    userIn = 0
    menuOptions = ["1 - transpose matrix", "2 - reduced row echelon form", "3 - row echelon form" "4 - Solve Via Linear Equation", "else - exit"]
    while userIn < len(menuOptions):
        ...
        matrix1 = sy.Matrix([[a1, b1, c1], [a2, b2, c2], [a3, b3, c3]])
        sy.pprint(matrix1)
